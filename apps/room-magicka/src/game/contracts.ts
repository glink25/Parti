export const SCHEMA_VERSION=4, WORLD_WIDTH=4800, WORLD_HEIGHT=3360, HUD_HEIGHT=118, ELEMENT_SLOTS=4;
...
export type HostWorldReport={sequence:number;enemies:EnemyState[];projectiles:HostProjectile[];environments:EnvironmentState[];encounters:RegionEncounter[]};
