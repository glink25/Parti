import { PLAYER_RADIUS, WORLD_WIDTH, type Platform } from '../game/contracts';
...
export function movingX(x: number, movement: Platform['movement'] | undefined, elapsedMs: number) {
