...
export type EncounterState = { id: string; roomId: string; kind: 'roaming' | 'sealed'; status: 'dormant' | 'active' | 'cleared'; monsterIds: string[]; waves: string[][]; currentWave: number; totalWaves: number; nextWaveAt: number | null; activatedAt: number | null; clearedAt: number | null };
